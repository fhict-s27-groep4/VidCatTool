...
namespace UnitTests.LogicLayer.SMTPMessageSender
{
    public class EMailSenderTests
    {
        SmtpClient client;
        MailMessage message;
        MailAddress frommailadress;
        MailAddress tomailadress;
        public EMailSenderTests()
        {
            client = new SmtpClient();
            client.Host = "http://smtp.gmail.com";
            frommailadress = new MailAddress("Test@gmail.com");
            tomailadress = new MailAddress("iek.sleddens@gmail.com");
            message = new MailMessage(frommailadress, tomailadress);
            message.Subject = "Retarded Unit Test";
        ...
        //    IMessageSettableMail mail = new MessageMail(message);
        //    mail.MakeMail(subject, content, emailss, attachmentss);
        //    eMailer.Send(mail, frommailadress);
        //}
    }
}
